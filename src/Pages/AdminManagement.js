...
import {getAdmins} from '../Components/GetItems'
...
class AdminManagement extends Component {
  ...
  addUserToList = () => new Promise((resolve,reject) => {
    ...
    fetch("https://my-helio-cart-admin.herokuapp.com/admins", {
        method: "POST",
        credentials: 'include',
...
modifyUserInfo = (event) => new Promise((resolve,reject) => {
...
removeUserFromList = (_id) => new Promise((resolve,reject) => {
    fetch(`https://my-helio-cart-admin.herokuapp.com/admins/${_id}`, {
        method: "DELETE",
        credentials: 'include'
    })
    .then(admins => {
...
removeUser = (user) => () => {
  ...
  render() {
      ...
      <Link style={{textDecoration: 'none', fontSize: 20}} to='/admin/user-management'>Manage Customer Accounts</Link>
      <div style={{display: 'flex', justifyContent: 'space-around'}}>
               ...
               <h1>Modify Admin</h1>
                <form style={{display: 'flex', flexDirection: 'column'}}>
                    ...
                    type="button" style = {{
                        ...
                        cursor: 'pointer',
                        alignSelf: 'center'}} 
                        onClick={this.modifyUser}>Update Item</button>
                <br></br>
        ...
        {/* ------------------------USER LIST DISPLAY ----------------------- */}
          ...
          <div style={{display: 'flex', flexDirection: 'column', flexWrap: 'wrap'}}>
            <h1>Administrative User List</h1>
